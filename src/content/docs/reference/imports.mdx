...
| JSON                              | nemo |
|----------------------------------|------------------------------------------------------------|
| `{"key1": value1, "key2": value2}` | `(0, type, "object")`, `(0, "key1",   1)`,                                      `(0, "key2", 2)`,                                      `(1, type, ...)`,                                      `(2, type, ...)` |
| `[value1, value2]`                 | `(0, type, "array")`,                                     `(0, 0, 1)`,                                     `(0, 1, 2)`,                                     `(1, type, ...)`,                                     `(2, type, ...)` |
| `"foobar"`                         | `(0, type, "string")`,                                      `(0, value, "foobar")` |
| `42.1337`                          | `(0, type, "number")`,                                     `(0, value, 42.1337)` |
| `true`                             | `(0, type, "bool")`,                                      `(0, value, "true"^^<http://www.w3.org/2001/XMLSchema#boolean>)` |
| `null`                             | `(0, type, "null")` |
